...
if "MARKETING_VERSION = 1.0.2" not in base_config:
    raise SystemExit("Base.xcconfig 的更新版本号不是 1.0.2")
if "CURRENT_PROJECT_VERSION = 3" not in base_config:
    raise SystemExit("Base.xcconfig 的更新构建号不是 3")
